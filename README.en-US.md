...
- **Ultimate Security**: The system randomly generates high-strength initial passwords, and the frontend includes built-in anti-brute-force delays. SSH credentials stored in SQLite are dynamically encrypted/decrypted in memory using AES-256-CFB, and Web UI resources are completely localized.
